												...
												<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
													<div className="text-xs">
														...
														<div>
															RM{" "}
															{
																product.lateFeeFixedAmount
															}{" "}
															every{" "}
															{
																product.lateFeeFrequencyDays
															}{" "}
															days
														</div>
													</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									...
									<div>
										...
										<input
											type="number"
											value={
												formData.lateFeeFrequencyDays ||
												7
											}
											onChange={(e) =>
												setFormData({
													...formData,
													lateFeeFrequencyDays:
														parseInt(
															e.target.value
														),
												})
