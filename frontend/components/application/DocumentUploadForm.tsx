		...
		>
			...
			<div className="flex justify-between pt-6">
				...
				<button
					...
					className="px-8 py-3 bg-purple-primary text-white rounded-xl hover:bg-teal-600 transition-all duration-200 font-medium font-body shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-purple-primary"
				>
					Continue
				</button>
			</div>
