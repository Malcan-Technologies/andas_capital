				...
				<div className="p-6 sm:p-8 border-b border-gray-100">
					<div className="flex items-center justify-between">
						<div className="flex items-center">
							<div className="w-12 h-12 lg:w-14 lg:h-14 bg-gray-500/10 rounded-xl flex items-center justify-center mr-3 flex-shrink-0">
								<VideoCameraIcon className="h-6 w-6 lg:h-7 lg:w-7 text-gray-600" />
							</div>
					...
					<div className="mb-8 p-6 bg-amber-50 rounded-xl border border-amber-200">
						<div className="flex items-start space-x-4">
							...
							<div className="flex-1">
								<h3 className="text-lg font-bold text-gray-700 font-heading mb-2">
						...
						<div className="relative border border-purple-200 bg-purple-50 rounded-xl p-6 shadow-sm">
							...
							<div className="flex items-center space-x-3 mb-4">
								...
								<div>
									...
									<p className="text-sm text-purple-primary font-semibold font-body">
										Complete in minutes
									</p>
								</div>
							</div>
							...
							<div className="space-y-3">
								<div className="flex items-center space-x-3">
									<div className="w-5 h-5 bg-purple-primary rounded-full flex items-center justify-center">
										<svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
											<path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
										</svg>
									</div>
									<span className="text-sm text-gray-600 font-body">Complete in ~3 minutes</span>
								</div>
								<div className="flex items-center space-x-3">
									<div className="w-5 h-5 bg-purple-primary rounded-full flex items-center justify-center">
										<svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
									...
									<span className="text-sm text-gray-600 font-body">Available 24/7 instantly</span>
								</div>
								<div className="flex items-center space-x-3">
									<div className="w-5 h-5 bg-purple-primary rounded-full flex items-center justify-center">
										<svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
									...
									<span className="text-sm text-gray-600 font-body">No scheduling required</span>
								</div>
								<div className="flex items-center space-x-3">
									<div className="w-5 h-5 bg-purple-primary rounded-full flex items-center justify-center">
										<svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
									...
									<span className="text-sm text-gray-600 font-body">Proceed immediately</span>
								</div>
							</div>
						</div>
