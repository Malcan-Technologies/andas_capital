...
export default function OTPVerificationPage() {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      if (
        ...
        certCheckData.data?.certStatus === "ACTIVE"
      ) {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      const kycResponse = (await fetchWithTokenRefresh(`/api/kyc/images`, {
        method: "GET",
      })) as any;

      if (!kycResponse.images) {
        throw new Error(
          "KYC documents not found. Please complete KYC verification first."
        );
      }
      ...
      if (!front || !back || !selfie) {
        throw new Error(
          "Required KYC documents (IC front, IC back, selfie) not found. Please complete KYC verification first."
        );
      }
      ...
      if (!front.url || !back.url || !selfie.url) {
        throw new Error(
          "KYC document URLs are missing. Please contact support."
        );
      }
      ...
      const statusMsg =
        certificateResponse.data?.statusMsg || certificateResponse.message;
      ...
      if (statusCode === "000") {
        ...
        switch (statusCode) {
          case "AP100":
            errorMessage =
              "Certificate auto-enrollment failed. Please contact support.";
            break;
          case "AP101":
            errorMessage =
              "Missing required information. Please ensure all fields are completed.";
            break;
          case "AP102":
            errorMessage =
          ...
          case "AP105":
            errorMessage =
              "Invalid nationality. Please ensure your nationality is set correctly.";
            break;
          case "AP108":
            errorMessage =
              "Invalid image file. Please ensure your KYC images are valid.";
            break;
          case "AP109":
            errorMessage =
              "Invalid image format. Please ensure your KYC images are in the correct format.";
            break;
          case "AP110":
            errorMessage =
              "Invalid ID type. Please ensure your IC information is correct.";
            break;
          case "AP111":
            errorMessage =
              "You already have a certificate. Proceeding to document signing.";
          ...
          case "AP112":
            errorMessage =
              "Invalid OTP code. Please check the OTP you entered.";
            break;
          case "AP113":
          ...
          case "AP115":
            errorMessage =
              "KYC verification error. Please complete KYC verification first.";
            break;
          case "AP121":
            errorMessage =
              "You already have an active certificate request. Please wait for processing to complete.";
            break;
          case "AP122":
            errorMessage =
              "Document size is too large. Please contact support.";
            break;
          case "AP123":
            errorMessage =
              "No document to upload. Please ensure KYC documents are available.";
            break;
          default:
      ...
      await fetchWithTokenRefresh(`/api/loan-applications/${params.id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (err instanceof Error && err.message.includes("404")) {
        setError(
          "KYC documents not found. Please complete KYC verification first, then try again."
        );
      } else {
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to go back to KYC verification"
      );
    }
  };
            ...
            <div className="text-center py-12">
              ...
              <div className="max-w-md mx-auto">
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {error ||
                    "Application not found. Please check if the application exists and try again."}
                </p>
  ...
  if (
    application.status !== "PENDING_SIGNING_OTP" &&
    application.status !== "PENDING_CERTIFICATE_OTP"
  ) {
    return (
      <DashboardLayout {...layoutProps}>
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="text-center py-12">
              ...
              <div className="max-w-md mx-auto">
                <p className="text-gray-600 mb-6 leading-relaxed">
                  This application is currently in "{application.status}" status
                  and does not require OTP verification at this time.
                </p>
                ...
                <div className="space-y-1 text-sm text-gray-600">
                  <div>
                    ...
                    <span className="font-medium text-green-600">
                      {certificateData.statusMsg || "Success"}
                    </span>
                  </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between text-sm">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2 text-purple-primary font-medium">
                  Certificate Request
                </span>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-blue-700 font-body mb-4">
                    We'll send a 6-digit verification code to your confirmed
                    email address.
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
                      <span className="text-blue-800 font-body text-lg">
