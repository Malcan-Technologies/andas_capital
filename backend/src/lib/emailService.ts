...
class EmailService {
  ...
  async sendDefaultArrearsNoticeEmail(options: {
    ...
    const htmlContent = `
      ...
      <p>Best regards,<br>Andas Capital</p>
...
We are writing regarding your loan account with Andas Capital for ${options.productName}. Our records show that your account has payments in arrears and this message serves as formal notice of default status in line with the formal letter attached (PDF).
